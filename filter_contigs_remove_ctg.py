...
def get_lower_coverage_perc_contigs(candidate_contigs_file, gc_content_dir, coverage_threshold=80, gc_average=48.17612378, std=0.4248436506552748):
...
if __name__ == "__main__":
    ...
    getted_lower_coverage_perc_contigs = get_lower_coverage_perc_contigs(candidate_contigs_file, getted_gc_content_dir, coverage_threshold=80, gc_average=48.17612378, std=0.4248436506552748)
