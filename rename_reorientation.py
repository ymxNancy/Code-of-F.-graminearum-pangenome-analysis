...
def parse_ragtag(strain_name):
    cmd = f'ragtag.py scaffold -t 40 /home/zhanghao/graminearum/rothamsted_research/PH1_nomt_renamed_ordered.fasta /home/zhanghao/graminearum/filter_contigs/filtered_genomes/{strain_name}_filtered.fas -o {strain_name}'
...
def get_original_contig_dir(strain_name):
    original_contig_dir = {}
    with open('/home/zhanghao/graminearum/filter_contigs/filtered_genomes/' + strain_name + '_filtered.fas', 'r') as f:
        for line in f:
            line = line.strip()
            if line.startswith('>'):
                key = line.replace('>', '')
...
def get_ordered_contig_file(strain_name, original_contig_dir):
    with open(strain_name + '/ragtag.scaffold.agp', 'r') as f1, open('/home/zhanghao/graminearum/order_contigs/ordered_genomes/' + strain_name + '_ordered.fas', 'w') as f2:
        n = 1
        for line in f1:
...
if __name__ == '__main__':
    ...
    os.chdir('/home/zhanghao/graminearum/order_contigs/order_tmp_files')
...
# Execution command: screen -L ./rename_reorientation.py all_isolates.txt
